 ...
 * Excel layout: 項目 (B) | 結果 (C) | 位 (D) | 配点 (E). Field names are in column B.
 */
...
export const resultSectionsQuantitative: ResultSectionType[] = [
  {
    title: "1 安全性項目",
    rows: [
      { label: "自己資本比率", resultCell: "C6", pointsCell: "E6", pointsEditable: false, resultSuffix: "%" },
      { label: "ギアリング比率", resultCell: "C7", pointsCell: "E7", pointsEditable: false, resultSuffix: "%" },
      { label: "固定長期適合率", resultCell: "C8", pointsCell: "E8", pointsEditable: false, resultSuffix: "%" },
      { label: "流動比率", resultCell: "C9", pointsCell: "E9", pointsEditable: false, resultSuffix: "%" },
    ],
  },
  {
    title: "2 収益性項目",
    rows: [
      { label: "売上高経常利益率", resultCell: "C12", pointsCell: "E12", pointsEditable: false, resultSuffix: "%" },
      { label: "総資本経常利益率", resultCell: "C13", pointsCell: "E13", pointsEditable: false, resultSuffix: "%" },
      { label: "収益フロー", resultCell: "C14", pointsCell: "E14", pointsEditable: false },
    ],
  },
  {
    title: "3 成長性項目",
    rows: [
      { label: "経常利益増加率", resultCell: "C17", pointsCell: "E17", pointsEditable: false, resultSuffix: "%" },
      { label: "自己資本額", resultCell: "C18", pointsCell: "E18", pointsEditable: false },
      { label: "売上高", resultCell: "C19", pointsCell: "E19", pointsEditable: false },
    ],
  },
  {
    title: "4 返済能力",
    rows: [
      { label: "債務償還年数", resultCell: "C22", pointsCell: "E22", pointsEditable: false, resultSuffix: " 年" },
      { label: "インタレスト・カバレッジ・レシオ", resultCell: "C23", pointsCell: "E23", pointsEditable: false, resultSuffix: " 倍" },
      { label: "キャッシュフロー額", resultCell: "C24", pointsCell: "E24", pointsEditable: false },
      { label: "事業者に有利な債務償還年数", resultCell: "C25", pointsCell: "E25", pointsEditable: false, resultSuffix: " 年" },
    ],
  },
];
...
export const resultSectionSubjective: ResultSectionType = {
  title: "主観項目",
  rows: [
    { label: "市場動向", resultCell: "", pointsCell: "E28", pointsEditable: true },
    { label: "景気感応度", resultCell: "", pointsCell: "E29", pointsEditable: true },
    { label: "市場規模", resultCell: "", pointsCell: "E30", pointsEditable: true },
    { label: "競合状態", resultCell: "", pointsCell: "E31", pointsEditable: true },
    { label: "業歴", resultCell: "", pointsCell: "E32", pointsEditable: true },
    { label: "経営者・経営方針", resultCell: "", pointsCell: "E33", pointsEditable: true },
    { label: "株主", resultCell: "", pointsCell: "E34", pointsEditable: true },
    { label: "従業員モラル", resultCell: "", pointsCell: "E35", pointsEditable: true },
    { label: "営業基盤", resultCell: "", pointsCell: "E36", pointsEditable: true },
    { label: "競争力", resultCell: "", pointsCell: "E37", pointsEditable: true },
    { label: "シェア", resultCell: "", pointsCell: "E38", pointsEditable: true },
  ],
};
...
export const ratingTableQuantitative: RatingRowType[] = [
  { score: "90以上", display: "1", tooltip: "倒産指数0" },
