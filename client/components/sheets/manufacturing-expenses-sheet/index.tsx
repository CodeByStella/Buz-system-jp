...
import {
  ManufacturingExpensesRowDataType,
  ManufacturingExpensesSummaryRowDataType,
  fixedExpensesRows,
...
export default function ManufacturingExpensesSheet() {
  ...
  const sheetName: SheetNameType = "manufacturing_expenses";
    ...
    () => [
      {
        ...
        render: (value: string, record: ManufacturingExpensesRowDataType) => {
          return (
            <div
              className={cn(
                record.bgcolor,
  ...
  const summaryTableColumns: Column[] = useMemo(
    () => [
      ...
      },
      {
        ...
        align: "center",
        cellClassName: "!p-0 !h-full relative",
        render: (value: string, record: ManufacturingExpensesSummaryRowDataType) => {
          return (
            <CustomInput
              type="number"
              sheet={sheetName}
