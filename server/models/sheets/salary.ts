...
const SalarySheetSchema = new Schema({
  ...
  personnelCostDetails: {
    ...
    employees: [{
      ...
      unitPrice: { type: Number, default: 0 }, // 単価 (Unit price per employee)
  ...
  miscellaneousSalaries: {
    ...
    partTimeEmployees: [{
      ...
      unitPrice: { type: Number, default: 0 }, // 単価 (Unit price per part-timer)
    ...
    arbeitEmployees: [{
      ...
      unitPrice: { type: Number, default: 0 }, // 単価 (Unit price per arbeit)
  ...
  dispatchedEmployees: {
    ...
    dispatched: [{
      ...
      unitPrice: { type: Number, default: 0 }, // 単価 (Unit price per dispatched employee)
    ...
    contract: [{
      ...
      unitPrice: { type: Number, default: 0 }, // 単価 (Unit price per contract employee)
