      ...
      employees: [
        {
          ...
          unitPrice: NumberInputSchema, // 単価 (Unit price per employee)
      ...
      partTimeEmployees: [
        {
          ...
          unitPrice: NumberInputSchema, // 単価 (Unit price per part-timer)
      ...
      arbeitEmployees: [
        {
          ...
          unitPrice: NumberInputSchema, // 単価 (Unit price per arbeit)
      ...
      dispatched: [
        {
          ...
          unitPrice: NumberInputSchema, // 単価 (Unit price per dispatched employee)
      ...
      contract: [
        {
          ...
          unitPrice: NumberInputSchema, // 単価 (Unit price per contract employee)
...
export type SalarySheetDocument = InferSchemaType<typeof SalarySheetSchema> & {
  _id: mongoose.Types.ObjectId;
};

export const SalarySheet: Model<SalarySheetDocument> =
  mongoose.models.SalarySheet ||
  mongoose.model<SalarySheetDocument>(
    "SalarySheet",
    SalarySheetSchema,
    "salary_sheets"
  );
